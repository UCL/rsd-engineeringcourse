...
# *just in time* or *ahead of time* compile Python code. Both the techniques allow
...
# %% [markdown]
# We can mark a function to be JIT compiled by simply decorating it
...
# good to measure the perrformance to check if there are any gains.
