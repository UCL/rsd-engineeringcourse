...
\begin{itemize}
  \item A JupyterLite server that, in particular, contains the codebase that you will be working on during the exam.
        It also contains the exam questions, broken down by their tasks, in HTML format for those who prefer this over the WiseFlow rendering (note that you will still need to enter your answers via WiseFlow, though).
