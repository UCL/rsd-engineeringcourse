...
\begin{itemize}
  \item The \codeWord{README} file, and it's inclusion of the basic ``need-to-know'' introduction that a newcomer to the project requires.
...
You should have a firm grasp of the fundamentals of the Python language, including it's syntax.
...
You are not expected to memorise specific design patterns, but should be able to identify whether a design pattern is being used (or not) given it's description.
